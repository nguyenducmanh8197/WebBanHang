...
<head>
    ...
    <link href="{{asset('styleAdmin1/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="{{asset('styleAdmin1/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<script src="{{asset('styleAdmin1/vendor/jquery/jquery.min.js')}}"></script>
<script src="{{asset('styleAdmin1/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

<!-- Core plugin JavaScript-->
<script src="{{asset('styleAdmin1/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

<!-- Custom scripts for all pages-->
<script src="{{asset('styleAdmin1/js/sb-admin-2.min.js')}}"></script>
